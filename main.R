...
t0 <- Sys.time()
source("scripts/02_model_base_titleix.R")
...
t0 <- Sys.time()
source("scripts/03_model_continuous_exposure.R")
...
t0 <- Sys.time()
source("scripts/04_model_18category_discrete.R")
...
t0 <- Sys.time()
source("scripts/05_model_trend_since1975.R")
...
t0 <- Sys.time()
source("scripts/06_model_school_stage.R")
...
t0 <- Sys.time()
source("scripts/07_model_generational_cohorts.R")
...
t0 <- Sys.time()
source("scripts/08_cross_validation.R")
